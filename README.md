...
| [`@carlosgtrz/pi-run-timer`](./packages/run-timer/README.md) | Shows elapsed, previous, and longest agent run times in the footer. | `pi install npm:@carlosgtrz/pi-run-timer` |
